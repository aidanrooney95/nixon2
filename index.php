...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link href='http://fonts.googleapis.com/css?family=Comfortaa' rel='stylesheet' type='text/css'/>
		...
		if(window.screen.width < 0) {//change back to 1000 after testing
			window.location.replace("http://www.aidanrooney.co.uk/nixon/mobile.php");
		}
		...
		function zeroToOne() {
					...
					var imageOneWidthNumber = imageOneWidth.split("%");
						if (imageOneWidthNumber[0] <= 99) {
							var imageOneNewWidth = parseInt(imageOneWidthNumber[0]) +5;
					...
					var imageOnePosNumber = imageOnePos.split("%");
						if (imageOnePosNumber[0] >= 1) {
							var imageOneNewPos = parseInt(imageOnePosNumber[0])-5;
					...
					var imageZeroWidthNumber = imageZeroWidth.split("%");
						if (imageZeroWidthNumber[0] >= 1) {
							var imageZeroNewWidth = parseInt(imageZeroWidthNumber[0]) -5;
		...
		function oneToTwo() {
					...
					var imageTwoWidthNumber = imageTwoWidth.split("%");
						if (imageTwoWidthNumber[0] <= 99) {
							var imageTwoNewWidth = parseInt(imageTwoWidthNumber[0]) +5;
					...
					var imageTwoPosNumber = imageTwoPos.split("%");
						if (imageTwoPosNumber[0] >= 1) {
							var imageTwoNewPos = parseInt(imageTwoPosNumber[0])-5;
		...
		function twoToZero() {
					...
					var imageZeroPosNumber = imageZeroPos.split("%");
						if (imageZeroPosNumber[0] >= 1) {
							var imageZeroNewPos = parseInt(imageZeroPosNumber[0])-5;
							var imageZeroNewPos = imageZeroNewPos+'%';
							document.getElementById('image0').style.left=imageZeroNewPos;
			...
			function collapse() {
				...
				document.getElementById('content').style.height="1620px";
				document.getElementById('container').style.height="2200px";
				} else {
				document.getElementById('collapse').style.display="none";
				document.getElementById('content').style.height="1550px";
				document.getElementById('container').style.height="2130px";
				}			
			}
		</script>
	</head>
	...
	<div id="container" style="height:2130px;">
		<div id="logo"></div>
		...
		<div id="slideshow">
			...
			<div id="slideshowLeft" onmouseover="slideshowLeftHover()" onmouseout="slideshowLeftOut()" onmouseup="slideshowLeft();"><img id="slideshowLeftImg" src="images/slideshowLeft.png" alt="slideshow left tab"/></div>
		...
		<div id="content" style="height:1550px;">
			<h1>
			...
			<p style="border-bottom:solid;border-width:2px;border-color:#ff33ff;padding-bottom:50px;">
			...
			<br/>
			<br/>
			<img src="images/grumpy-cat-placeholder-340x240.jpg" alt="grumpy cat" style="margin:auto;display:block;"/>
			<br/>
			...
			if (!isset($_POST["submit"])) {
				...
				Message&#42;:<br/>
				<textarea rows="10" cols="50" name="message" style="max-width:90%;max-height:150px;"></textarea><br/><br/>
	...
	<div id="contact">
		...
		<br/><br/>
		<img src="images/email-icon.png" width="23px" height="16px" alt="email icon"/><span style="font-size:20pt;font-weight:700;"> Email </span><a href="mailto:cupcake@nyancat.com" style="font-size:15pt;">cupcake@nyancat.com</a>
		<br/><br/>
		<img src="images/phone-icon.png" width="14px" height="20px" alt="phone icon"/><span style="font-size:20pt;font-weight:700;"> Telephone </span>+44 &#40;0&#41;1736 758 600
		<br/><br/>
